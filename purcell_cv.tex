...
\section*{Professional Experience}
  \begin{itemize}
      ...
      \item \textbf{Nicholas School of the Environment, Duke University}\\
...
\section*{Peer-Reviewed Publications}
    ...
    \item M. Karnauskas, M.J. Schirripa, J.K. Craig, G. Cook, C. Kelbe, J. Agar, B. Black, D. Enfield, D. Lindo-Atichati, B. Muhling, \textbf{K.M. Purcell}, P. Richards, C. Wang.  2014. Evidence of climate-driven ecosystem reorganization in the Gulf of Mexico.  \textit{Proceeding of the National Academy of Science}. (\textit{In review})
		...
		\item \textbf{K. M. Purcell} and C. A. Stockwell. 2014. An evaluation of the genetic structure and post-introduction dispersal of a non-native invasive fish to the North Island of New Zealand. \textit{Biological Invasions}, \textbf{DOI}:10.1007/s10530-014-0753-7.
  ...
  \subsection*{Advising/Mentoring}
   \begin{itemize}
    \item H. Oliver (University of Louisiana-Lafayette, undergraduate) \\
	  J. Fisher (North Dakota State University, graduate, Ph.D.) \\
	  B. Kowalski (North Dakota State University, graduate, M.S.)
   \end{itemize}
...
\section*{Miscellaneous}
  \begin{itemize}
    ...
    Airboat operation certification \\
    SCUBA diving (Advanced OW, Nitrox) \\
  \end{itemize}

  \subsection*{Computer Skills}
  	\begin{itemize}
  		\item \textbf{Languages}: R, SAS,  Python, ADMB, Perl, HTML, Javascript, Bash \\
  		\textbf{Applications}: \LaTeX, ArcGIS, GRASS, Git, Make, common Microsoft products \\
      \textbf{Operating Systems}: Unix/Linux, Windows, OS X
  	\end{itemize}
